...
jQuery(window).on("load",function() {	
	...
	function fullpageInit () {
		...
		jQuery('#fullpage').fullpage({
			...
			easingcss3: 'cubic-bezier(0.535, 0, 0, 1)',
			
			afterLoad: function(anchorLink, index){
				var leavingSection = jQuery(this);
				leavingSection.find("h2").removeClass("fadeOutDown").addClass('animated fadeInDown');
				leavingSection.find("h3").removeClass("fadeOutDown").addClass('animated fadeInDown');
				leavingSection.find("p").removeClass("fadeOutUp").addClass('animated fadeInUp');
				leavingSection.find(".sr-button").removeClass("fadeOutUp").addClass('animated fadeInUp');

				
			},
			onLeave: function(index, nextIndex, direction){
				var leavingSection = jQuery(this);
				leavingSection.find("h2").removeClass("fadeInDown").addClass(' fadeOutDown');
				leavingSection.find("h3").removeClass("fadeInDown").addClass(' fadeOutDown');
				leavingSection.find("p").removeClass("fadeInUp").addClass(' fadeOutUp');
				leavingSection.find(".sr-button").removeClass("fadeInUp").addClass('fadeOutUp');
			}
	...
	if(jQuery('html').hasClass("tablet") ){
		jQuery('#hero.videobg-section').remove();
		fullpageInit();
	}

	if(jQuery('html').hasClass("mobile")){
		jQuery('#hero.videobg-section').remove();
		jQuery('.instafeed').remove();
		jQuery('#footer .spacer-big').remove();
	}
